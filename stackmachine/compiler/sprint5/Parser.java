 ...
 public class Parser implements IParser {
    ...
    private void statement() throws Exception {
		...
		if (tokenName.equals("int") || tokenName.equals("float") || tokenName.equals("boolean")) {
		    ...
		    // If true check if more than one statement (curly brackets required)
		    if (tokenName.equals("open-curly-bracket")) {
		    ...
		    if (this.token.getName().equals("else")) {
		        ...
		        // Check to see if more than one statement
		        if (this.token.getName().equals("open-curly-bracket")) {
            ...
            // if the statement is true: perform while loop operation
            match("open-curly-bracket");
			...
			// If more than one statement for do
		    if (this.token.getName().equals("open-curly-bracket")) {
